...
import { Geist, Geist_Mono, Inter, Funnel_Display, Playwrite_FR_Moderne_Guides } from "next/font/google";
import "./globals.css";
...
export default function RootLayout({
  ...
  const classes = cn("antialiased", geistSans.variable, geistMono.variable, inter.variable, funnelDisplay.variable, playwrite.variable);
  return (
