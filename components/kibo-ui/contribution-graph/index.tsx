...
export const ContributionGraphBlock = ({
  ...
  return (
    <rect
      className={cn(
        'data-[level="0"]:fill-neutral-400/10',
        'data-[level="1"]:fill-neutral-400/30',
        'data-[level="2"]:fill-neutral-400/50',
        'data-[level="3"]:fill-neutral-400/70',
        'data-[level="4"]:fill-neutral-400/90',
        className
      )}
