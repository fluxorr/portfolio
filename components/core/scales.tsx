...
export const Scales = ({
  ...
  return (
    ...
    >
      <div
        className="h-full w-full bg-[repeating-linear-gradient(var(--scales-angle),var(--pattern-scales)_0,var(--pattern-scales)_1px,transparent_0,transparent_50%)] border-x border-border/50 "
        style={{
