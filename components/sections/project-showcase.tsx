...
import { siGithub, siReact, siNextdotjs, siTailwindcss, siTypescript, siJavascript, siCss } from "simple-icons"
    ...
    return (
        ...
        >
            <div className="px-4 pt-4 pb-2 relative z-10">
                ...
                <TextAnimate by="line" animation="slideRight" className="font-display text-2xl px-4 text-foreground mt-1">
                    Projects
                </TextAnimate>
            </div>

            <AnimateElement by="children" animation="slideUp" startOnView once className="divide-y divide-dashed divide-neutral-400/30">
                {projects.map((p, i) => {
                            ...
                            <div className="flex-1 min-w-0 relative z-10">
                                ...
                                <div className="flex items-center gap-2.5 mt-3">
                                    {p.tech.map((slug) => {
                                        ...
                                        if (!icon) return null
                                        return (
                                            <span key={slug} className="text-muted-foreground/50 group-hover:text-muted-foreground/70 transition-colors" title={icon.title}>
            ...
            {hovered !== null && (
                <motion.div
                    ...
                    transition={{ duration: 0.25, left: { duration: 0.15 }, top: { duration: 0.15 } }}
